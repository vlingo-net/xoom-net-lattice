...
{
    /// <summary>
    /// Implementation based on https://stackoverflow.com/a/13776636/261950
    /// </summary>
    ...
    public abstract class Heap<T> : IEnumerable<T>
    {
        ...
        protected Heap(IEnumerable<T> collection, Comparer<T> comparer)
        {
            ...
            for (var i = Parent(_tail - 1); i >= 0; i--)
                BubbleDown(i);
        }
        ...
        private static int YoungChild(int i) => (i + 1) * 2 - 1;

        private static int OldChild(int i) => YoungChild(i) + 1;

        private void Grow()
        {
            var newCapacity = _capacity * GrowFactor + MinGrow;
        ...
        public IEnumerator<T> GetEnumerator() => _heap.Take(Count).GetEnumerator();
    ...
    public class MaxHeap<T> : Heap<T>
    {
        ...
        protected override bool Dominates(T x, T y) => Comparer.Compare(x, y) >= 0;
    }
