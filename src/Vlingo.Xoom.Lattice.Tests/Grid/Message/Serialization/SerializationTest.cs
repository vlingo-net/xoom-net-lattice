...
namespace Vlingo.Xoom.Lattice.Tests.Grid.Message.Serialization
{
    public class SerializationTest
    {
        ...
        public void TestThatEncodesDecodesDeliverMessage()
        {
            ...
            var deliver = new Deliver<ISimpleParametersInterface>(
                typeof(ISimpleParametersInterface),
                new GridAddress(Guid.NewGuid()),
                Definition.SerializationProxy<ISimpleParametersInterface>.From(
        ...
        {
            Expression<Action<ISimpleParametersInterface>> consumer = actor => actor.DoSomething("Test Consumer", 100);
            var deliver1 = new Deliver<ISimpleParametersInterface>(
                typeof(ISimpleParametersInterface),
                new GridAddress(Guid.NewGuid()),
                Definition.SerializationProxy<ISimpleParametersInterface>.From(
                    Definition.Has<ISimpleParametersInterface>(() => new ActorTest())),
            ...
            var deliver2 = new Deliver<ISimpleParametersInterface>(
                typeof(ISimpleParametersInterface),
                new GridAddress(Guid.NewGuid()),
                Definition.SerializationProxy<ISimpleParametersInterface>.From(
                    Definition.Has<ISimpleParametersInterface>(() => new ActorTest())),
            ...
            var delivers = new List<Deliver<ISimpleParametersInterface>>
            {
                deliver1,
                deliver2
            };
            var relocate = new Relocate<ISimpleParametersInterface>(
                new GridAddress(Guid.NewGuid()),
                Definition.SerializationProxy<ISimpleParametersInterface>
        ...
        {
            var start = new Start<ISimpleParametersInterface>(
                new GridAddress(Guid.NewGuid()),
                Definition.SerializationProxy<ISimpleParametersInterface>
                    .From(Definition.Has<ISimpleParametersInterface>(() => new ActorTest())));
            var encoder = new JsonEncoder();
        ...
        public void TestThatEncodesUnAckMessage()
        {
            ...
            var deliver = new Deliver<ISimpleParametersInterface>(
                ...
                Guid.NewGuid(),
                "Deliver representation");
            var unack = new UnAckMessage<ISimpleParametersInterface>(Id.Of(50),
